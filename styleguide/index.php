...
<div class="st-tabs">
    <a class="st-tabs__tab" href="#tab1">
        Colors
    </a>

    <a class="st-tabs__tab" href="#tab2">
        Typography
    </a>

    <a class="st-tabs__tab" href="#tab3">
        Buttons
    </a>

    <a class="st-tabs__tab" href="#tab4">
        Forms
    </a>
...
<div class="st-tabs-content container" id="tab3">
    <h2 class="st-heading u-mb2">Buttons</h2>

    <div class="u-mb3">
        <h3 class="u-mb2">Default buttons</h3>
    ...
    <div>
        <h3 class="u-mb2">Primary and secondary buttons</h3>
        <button class="btn btn--primary">Button primary</button>
        <button class="btn btn--secondary">Button secondary</button>
    </div>
</div>

<div class="st-tabs-content container" id="tab4">
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="number" id="number" min="0" max="10" step="1" value="5" />
        </div>
